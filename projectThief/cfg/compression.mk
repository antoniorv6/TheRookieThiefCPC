...
$(eval $(call ADD2PACK,room2_pack,src/levels/room2.bin))
$(eval $(call PACKZX7B,room2_pack,src/compressedLevels/))


$(eval $(call ADD2PACK,room3_pack,src/levels/room3.bin))
$(eval $(call PACKZX7B,room3_pack,src/compressedLevels/))

$(eval $(call ADD2PACK,room4_pack,src/levels/room4.bin))
$(eval $(call PACKZX7B,room4_pack,src/compressedLevels/))

$(eval $(call ADD2PACK,room5_pack,src/levels/room5.bin))
$(eval $(call PACKZX7B,room5_pack,src/compressedLevels/))

$(eval $(call ADD2PACK,room6_pack,src/levels/room6.bin))
$(eval $(call PACKZX7B,room6_pack,src/compressedLevels/))
