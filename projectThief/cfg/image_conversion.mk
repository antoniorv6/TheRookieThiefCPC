...
PALETTE= 0 2 3 4 5 7 9 10 11 12 14 20 23 24 25
$(eval $(call IMG2SP, SET_FOLDER, src/tiles/))
$(eval $(call IMG2SP, SET_PALETTE_FW , $(PALETTE) ))
$(eval $(call IMG2SP, CONVERT_PALETTE , $(PALETTE), tileset_palette ))
$(eval $(call IMG2SP, CONVERT, tilesets/tileset.png , 4, 4, room_tileset,, tileset))

#HERO
$(eval $(call IMG2SP, SET_FOLDER, src/sprites/))
$(eval $(call IMG2SP, SET_MASK        , interlaced               ))
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites   ))
$(eval $(call IMG2SP, CONVERT, sprites/hero/hero_idle-sheet.png , 8, 32, idle,, ))

$(eval $(call IMG2SP, CONVERT, sprites/hero/hero_attack-sheet.png , 8, 32, attack,, ))
$(eval $(call IMG2SP, CONVERT, sprites/hero/hero_run-sheet.png , 8, 32, run,, ))
$(eval $(call IMG2SP, CONVERT, sprites/hero/hero_jump-sheet.png , 8, 32, jump,, ))
$(eval $(call IMG2SP, CONVERT, sprites/hero/hero_protect-sheet.png , 8, 32, protect,, ))

#ENEMY
$(eval $(call IMG2SP, CONVERT, sprites/enemies/enemy_idle-sheet.png , 8, 32, enemy_idle,, ))
$(eval $(call IMG2SP, CONVERT, sprites/enemies/enemy_attack-sheet.png , 8, 32, enemy_attack,, ))
$(eval $(call IMG2SP, CONVERT, sprites/enemies/enemy_run-sheet.png , 8, 32, enemy_run,, ))

#KEY
$(eval $(call IMG2SP, CONVERT, sprites/assets/key.png , 8, 16, key,, ))
$(eval $(call IMG2SP, CONVERT, sprites/assets/key_highlight.png , 8, 16, key_highlight,, ))

#CASH
$(eval $(call IMG2SP, CONVERT, sprites/assets/cash.png , 8, 16, cash,, ))
$(eval $(call IMG2SP, CONVERT, sprites/assets/cash_highlight.png , 8, 16, cash_highlight,, ))

#DOOR
$(eval $(call IMG2SP, CONVERT, sprites/assets/door.png , 8, 32, door,, ))
